...
function sortBooks(books) {
  ...
  if (pageState.arrangement === "oldest") {
    return sortedBooks.sort((a, b) => new Date(a.addedAt || 0) - new Date(b.addedAt || 0));
  }

  return sortedBooks.sort((a, b) => new Date(b.addedAt || 0) - new Date(a.addedAt || 0));
}
