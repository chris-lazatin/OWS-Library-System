...
export const bookFieldGroups = [
  {
    title: "Title Proper",
    fields: [
      { label: "Title Proper", name: "title", required: true },
      { label: "Responsibility", name: "responsibility" },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "Date", name: "publicationDate", type: "date" },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "On Shelf", name: "onShelf", type: "number" },
